    ...
    try {
        ...
        await applications.recordset.forEach((application) => {
            ...
            if (contactsByEmail[email]) {
                ...
                // Add contact information to the application object
                const applicationObject = {
                    ...
                    // (if it's not already added, you may want to check for duplicates)
                    applications: [
                        ...contact.applications,
                        {
                            ...
                            study_location_code:
                                application.STUDY_LOCATION_CODE || undefined,
                            study_location_description:
                                application.STUDY_LOCATION_DESCRIPTION ||
                                undefined,
                            study_location_postcode:
                                application.STUDY_LOCATION_POSTCODE ||
                                undefined,
                            qualification_type:
                                application.QUALIFICATION_TYPE || undefined,
                            stage: application.STAGE,
                ...
                contactsByEmail[email].applications.push(applicationObject);
            }
        });
